...
{:ok, _cs} = Project.UserContext.create_admin(%{"password" => "t", "role" => "Admin", "first_name" => "test", "last_name" => "admin", "email" => "admin@test.com", "country" => "BE", "city" => "Leuven", "postal_code" => "3000", "street" => "Tiensestraat", "number" => "200"})
