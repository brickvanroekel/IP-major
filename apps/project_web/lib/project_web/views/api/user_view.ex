defmodule ProjectWeb.Api.UserView do
  ...
  #def render("orders.json", %{orders: orders}) do
   # %{data: render_many(orders, UserView, "order.json")} # Create a json with key = data & value = an array of orders. The render_many is used to call render on every attribute in the (orders)-list
  #end
